...
module.exports = {
  ...
  envVar: function() {
    inquire.prompt([
      ...
      exec('echo "export ' + answers.key + '=' + answers.val + '" >> ' + config.shell.config, function(err, stdout, stderr) {
        if (err) {
          log.err(err);
        } else {
          ...
          log.general('Either restart your terminal or run "source ' + cPath + '". I can\' run that for you!');
        }
      });
    });
  }
